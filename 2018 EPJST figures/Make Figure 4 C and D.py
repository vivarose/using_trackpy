## Run this cell in the tracers notebook
## drift subtracted vs non drift subtracted.ipynb
## Then send the png and pdf files to Viva
...
print("Tracer 3% $H_2O_2$ vs Tracers no $H_2O_2$ tracer particles")
...
axC.tick_params(which='both', pad=3)
...
try:
    plt.savefig('Tracer 3% H2O2 vs Tracers no H2O2 tracer particles.pdf', 
                bbox_inches='tight', figsize=(thiswidth, thisheight))
    print('pdf saved')
    plt.savefig('Tracer 3% H2O2 vs Tracers no H2O2 tracer particles.png', 
...
try:
    plt.savefig('Tracer 3% H2O2 vs Tracers no H2O2 tracer particles despine.pdf', 
                bbox_inches='tight', figsize=(thiswidth, thisheight))
    print('pdf saved')
    plt.savefig('Tracer 3% H2O2 vs Tracers no H2O2 tracer particles despine.png', 
                bbox_inches='tight', dpi=600, figsize=(thiswidth, thisheight))
except IOError:
    print('Close the pdf file so I can overwrite it.')
